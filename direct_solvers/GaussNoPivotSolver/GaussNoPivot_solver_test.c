...
void test_gaussNoPivot(const char *matrix_filename, const char *vector_filename){
    ...
    printf("\nSolution of system by Gauss with no pivot, x_solve:\n");
    ...
    if(equals(b, multiply(A_temp, x_solve), 0.0000000001) == 0)
...
void main(int argc, char* argv[]){
    ...
    if(argc==3){
        ...
        test_gaussNoPivot(argv[1], argv[2]);
    }
}
