...
void test_solve_choleskyModified(const char *matrix_filename, const char *vector_filename){
    ...
    //printf("\nSolution of system by modified Cholesky factorization, x_solve:\n");
...
void main(int argc, char* argv[]){
    ...
    if(argc==3){
        ...
        test_solve_choleskyModified(argv[1], argv[2]);
    }
}
